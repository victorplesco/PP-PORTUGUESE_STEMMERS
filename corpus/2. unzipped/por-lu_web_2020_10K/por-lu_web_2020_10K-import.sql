...
CREATE DATABASE `por-lu_web_2020_10K`;

USE `por-lu_web_2020_10K`;
...
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'por-lu_web_2020_10K-sources.txt' INTO TABLE sources;
